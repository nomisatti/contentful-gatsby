        ...
        <>    
            ...
            <div className="w3-card w3-margin w3-margin-top">
                ...
                <div className="w3-container w3-white">
                    ...
                    <a href="https://www.facebook.com/noumasatti39/" className="fa fa-facebook">F</a>
                    <a href="https://github.com/nomisatti" className="fa fa-github">G</a>
                    <a href="https://www.linkedin.com/in/noumanatiq/" className="fa fa-linkedin">L</a>
